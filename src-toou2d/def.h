...
namespace Toou2D_Position {
Q_NAMESPACE
enum Toou2D_PositionType {
    Left,
    Reght,
    Top,
    Bottom,
...
Q_ENUMS(Toou2D_PositionType);
}

//qml type TIconType.
namespace Toou2D_Icon {
Q_NAMESPACE
enum Toou2D_IconType {
    Awesome,
    SVG,
};
Q_ENUMS(Toou2D_IconType);
}

//qml type TTimePreset.
namespace Toou2D_Time {
Q_NAMESPACE
enum class Toou2D_TimePreset {
    DevilTime3600s = 500,   // :)
    T1s        = 1 * 1000,
    T2s        = 2 * 1000,
    T3s        = 3 * 1000,
...
Q_ENUMS(Toou2D_TimePreset);
}

//h1=32px h2=24px h3=19px h4=16px h5=14px h6=12px
//qml type TTimePreset.
namespace Toou2D_PixelSize {
Q_NAMESPACE
enum class Toou2D_PixelSizePreset {
    PH1   = 32,
    PH2   = 24,
    PH3   = 19,
    PH4   = 16,
...
Q_ENUMS(Toou2D_PixelSizePreset);
}

//qml type TAwesomeType.
//已经支持最新的4.7.0   785个图标
//http://www.fontawesome.com.cn/faicons/
namespace Toou2D_Awesome {
Q_NAMESPACE
enum class Toou2D_AwesomeType{
    FA_glass 			= 0xf000,
    FA_music 			= 0xf001,
    FA_search 			= 0xf002,
