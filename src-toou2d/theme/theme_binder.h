...
public:
  ...
  Q_PROPERTY(QStringList dynamicListener READ dynamicListener WRITE
                 setDynamicListener NOTIFY dynamicListenerChanged)
  Q_PROPERTY(QObject *target READ target WRITE setTarget NOTIFY targetChanged)
  Q_PROPERTY(QString childName READ childName WRITE setChildName NOTIFY
                 childNameChanged)
  Q_PROPERTY(QString groupName READ groupName WRITE setGroupName NOTIFY
                 groupNameChanged)
  Q_PROPERTY(QString className READ className WRITE setClassName NOTIFY
                 classNameChanged)
  Q_PROPERTY(bool enabled READ enabled WRITE setEnabled NOTIFY enabledChanged)
  Q_PROPERTY(QString state READ state WRITE setState NOTIFY stateChanged)
  Q_PROPERTY(bool stateAsynchronous READ stateAsynchronous WRITE
                 setStateAsynchronous NOTIFY stateAsynchronousChanged)
  Q_PROPERTY(QStringList filterPropertyName READ filterPropertyName WRITE
                 setFilterPropertyName NOTIFY filterPropertyNameChanged)
  Q_PROPERTY(
      ThemeBinder *parent READ parent WRITE setParent NOTIFY parentChanged)
...
private:
  inline bool mGetThemeDataFromManager(const QString &property,
                                       QVariant &value);
